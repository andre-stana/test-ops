...
export async function sendDiscordMessageByDM(accesToken: string, channelId: string, message: string): Promise<void> {
...
export async function getDiscordUserDM(accessToken: string): Promise<{ id: string; name: string }[]> {
